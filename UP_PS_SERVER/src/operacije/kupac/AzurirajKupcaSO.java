 ...
 * @author puaca
 */
public class AzurirajKupcaSO extends ApstraktnaGenerickaOperacija{

    @Override
    protected void preduslovi(Object objekat) throws Exception {
        if(objekat == null || !(objekat instanceof Kupac)){
            throw new Exception("Sistem ne moze da azurira kupca");
        }
        ...
        if(k.getEmail()==null || k.getEmail().isEmpty()){
            throw new Exception("Email mora biti unesen");
        }
        if(k.getTelefon()==null || k.getTelefon().isEmpty()){
            throw new Exception("Telefon mora biti unesen");
        }
    }
